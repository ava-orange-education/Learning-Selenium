 ...
 */
public class Chapter04_FluentWait {
	@Test(priority = 1)
	public void fluentWaitExample() throws Exception {
		...
		driver.get("https://ava-orange-education.github.io/Ultimate-Selenium-WebDriver-for-Test-Automation/docs/Chapter3_Waits.html");
